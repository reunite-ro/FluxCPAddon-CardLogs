            ...
            <tbody>
                <?php foreach ($dropLogs as $log): ?>
                    <tr>
                        ...
                        <td class="monster-image-cell">
                            <!-- Display Mini-Boss monster image -->
                            <img src="https://controlpanel.reunite-ro.com/data/monsters/<?php echo $log->mini_boss_id ?>.gif" 
                                 alt="<?php echo htmlspecialchars($log->mini_boss_name) ?>" 
                                 title="<?php echo htmlspecialchars($log->mini_boss_name) ?>" 
                                 class="monster-image" />
                        </td>
                        <td>
                            <!-- Display Mini-Boss monster name -->
...
.horizontal-table thead th:nth-child(2) {
    background-color: #1e88e5; /* Mini-Boss column */
}
